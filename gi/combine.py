...
def merge_with_existing(existing_text: str, new_text: str, strategy: str = "append") -> str:
...
def generate_header(template_names: List[str], source_url: str = "github/gitignore (HEAD)") -> str:
...
def combine_templates(
    ...
    if append and existing_content:
        combined_content = merge_with_existing(existing_content, combined_content, "append")
