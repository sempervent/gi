...
class TestGetCacheDir:
    ...
    def test_get_cache_dir_windows(self):
        ...
        with patch("platform.system", return_value="Windows"):
            with patch("platformdirs.user_cache_dir", return_value="/mock/cache/gi") as mock_cache_dir:
    ...
    def test_get_cache_dir_posix(self):
        ...
        with patch("platform.system", return_value="Linux"):
            with patch("platformdirs.user_cache_dir", return_value="/home/user/.cache/gi") as mock_cache_dir:
                with patch("pathlib.Path.mkdir") as mock_mkdir:
                    cache_dir = get_cache_dir()
    ...
    def test_get_cache_dir_creates_directory(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("gi.util.platformdirs.user_cache_dir", return_value=str(cache_path)):
                cache_dir = get_cache_dir()
